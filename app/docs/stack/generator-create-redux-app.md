# Create Redux App generator original README
...
`src/components/AppRouter` is the starter point of the app, where all the top-level routes are specified and render the containers and components. Specify here all your routes, redirects, transitions, etc.

Components may also design their own "nested" routing structures as necessary.  For more information on advanced routing with `react-router-dom`, see: https://reacttraining.com/react-router/web/guides/philosophy
