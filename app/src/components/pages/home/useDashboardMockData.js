  ...
  useEffect(() => {
    ...
    const load = async () => {
      ...
      if (eventsRes.status === 'fulfilled') {
        setEvents(eventsRes.value && eventsRes.value.data && eventsRes.value.data.events ? eventsRes.value.data.events : [])
      ...
      if (notificationsRes.status === 'fulfilled') {
        setNotifications(
          notificationsRes.value && notificationsRes.value.data && notificationsRes.value.data.notifications
