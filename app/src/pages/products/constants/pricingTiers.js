export const PRICING_TIER_OPTIONS = [
  ...
  { value: 'premium_custom', label: 'Premium - Custom', displayLabel: 'Premium (Custom)', defaultPrice: null },
  { value: 'discount_custom', label: 'Discount - Custom', displayLabel: 'Discount (Custom)', defaultPrice: null },
]
